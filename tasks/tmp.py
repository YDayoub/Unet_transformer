...
Security
Insights
awd-lstm-lm/pointer.py /
@Smerity
Smerity Add QRNN as an optional RNN model to use - multiple times faster than…
…
Latest commit 1b3294d on Oct 5, 2017
 History
 1 contributor
135 lines (122 sloc)  5.54 KB
...
def evaluate(data_source, batch_size=10, window=args.window):
    ...
    for i in range(0, data_source.size(0) - 1, args.bptt):
        ...
        rnn_out = rnn_outs[-1].squeeze() # seq_len, batch_size, d_model
        ...
        #print(next_word_history) # seq_len*batch_size, ntokens
        ...
        #print(pointer_history) # seq_len, batch_size, d_model
        ###
